...
#### selectAttribute(attributePaths:[string], add:bool) {/* #selectattribute */}
...
#### deselectAttribute(attributePaths:[string]) {/* #deselectattribute */}
...
#### getEffectiveAttributeDefinition(layerId:string, attrId:string) → object {/* #geteffectiveattributedefinition */}
...
#### getProfileName(assetId:string) → string {/* #getprofilename */}
