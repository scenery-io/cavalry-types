...
:::info Starter licences

Users with a **Starter** licence can install and use **encrypted** Scripts meaning Scripts downloaded from third-parties who have encrypted their Scripts can also be used in the free version of Cavalry.
