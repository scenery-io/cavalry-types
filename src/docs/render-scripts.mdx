...
When using [Dynamic Rendering](../../user-interface/menus/window-menu/render-manager/dynamic-rendering.mdx), the **Dynamic Index** can be accessed using the [api.getDynamicIndex()](./api-module.mdx#getdynamicindex---int) member.
:::
