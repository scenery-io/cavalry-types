...
#### lineIntersections(line:cavalry.Line) → array[object] {/* #lineintersections */}
...
#### pathIntersections(path:cavalry.Path) → array[object] {/* #pathintersections */}
...
#### lineIntersection(line:cavalry.Line) → \{x:number,y:number} {/* #lineintersection */}
